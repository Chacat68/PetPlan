...
> 历史设计（2026-07-21）：武器、搜索、警戒、背包与撤离规则已由 [远征玩法精简改版（2026-07-23）](./expedition-gameplay-simplification-20260723.md) 取代，当前界面见 [远征情境交互改版](./expedition-context-interaction-20260723.md)。本文仅保留初版设计背景，其中终端、右侧路线卡和手动换弹键位均不再适用；当前空弹自动换弹，`R` 用于补给。
