...
| [design/expedition-gameplay-simplification-20260723.md](./design/expedition-gameplay-simplification-20260723.md) | 当前远征玩法规则与验收目标 | 产品与开发 |
| [design/extraction-rpg-rework.md](./design/extraction-rpg-rework.md) | 宠物远征初版设计（历史） | 产品与开发 |
...
│   ├── expedition-gameplay-simplification-20260723.md # 当前远征规则
│   └── extraction-rpg-rework.md    # 初版搜打撤设计（历史）
└── dev/               # 开发者文档
    ├── setup.md          # 环境搭建
...
| ⚔️ 宠物远征 | 路线、搜索、战斗、撤离 | [当前远征规则](./design/expedition-gameplay-simplification-20260723.md) |
