...
- 将横向自动追击战斗改造成“宠物防线”纵向塔防。
- 新增 10 波敌军、固定路径、基地生命、第 10 波 Boss 和胜负结算。
- 上阵宠物改为固定宠物塔，支持波次间换位、局内升级及元素职业效果。
- 新增战斗能量、基地修复、失败部分奖励和玩家经验升级。
- 新增防线指挥面板、塔位点击交互、最佳波次记录和结算自动保存。
- 修正投射物中心碰撞，并限制大帧时间，避免页面恢复后敌人瞬间漏过整条路线。
- 新增 `tests/tower-defense-smoke.mjs` 和完整改造说明。
