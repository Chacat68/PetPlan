...
test("入口撤离开局可用，应急撤离要求更深进度和一份补给", () => {
  const entryRun = prepareExtractionRun({ depth: 0, supplies: 0 });
  ...
  assert.equal(EXTRACTION_RULES.entry.baseDurationMs, 4000);
  assert.equal(EXTRACTION_RULES.entry.baseEnemyCount, 1);
